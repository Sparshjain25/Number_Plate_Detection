...
import json
from getNumberPlateVals2 import detect_license_plate
import base64
import os
...
class ClientApp:
    def __init__(self):
        ...
        self.modelArg = "datasets/experiment_ssd/2021_03_25_14-00/model/frozen_inference_graph.pb"
    ...
    try:
        ...
        if labelledImage is not None:
            ...
            if len(numberPlateVal) < 15:
                ...
                responseList.append(numberPlateVal)
                # print(responseDict)
                # convert to json data
                jsonStr = json.dumps(responseDict['numberPlateVal'], ensure_ascii=False).encode('utf8')
                ...
                responseList.append(responseDict["numberPlateVal"])
                # print(responseDict)
                # convert to json data
